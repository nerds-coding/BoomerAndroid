...
import com.apgroup.boomer.databinding.FragmentLevelOneBinding
...
class Fragment_Level_One : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        binding=DataBindingUtil.inflate(inflater, R.layout.fragment_level_one,container,false)
        binding.lifecycleOwner=this

        viewModel= ViewModelProviders
            .of(this,ViewModelFactoryFile(1,6000L))
            .get(LevelOneAndTwoGameEngine::class.java)
        binding.levelOne=viewModel
    ...
    override fun onClick(v: View?) {
        ...
        if(counter==11){
            ...
            val action= Fragment_Level_OneDirections
                .actionFragmentLevelOneToFragmentScoreBoard(score,remark)
